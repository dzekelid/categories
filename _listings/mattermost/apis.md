...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/categories/master/_listings/mattermost/apis.md
...
- name: Mattermost API Reference - List a user's preferences by category
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/categories/master/_listings/mattermost/usersuser-idpreferencescategory-get-openapi.md
- name: Mattermost API Reference - List a user's preferences by category
  x-api-slug: usersuser-idpreferencescategory-get
  description: |-
    Lists the current user's stored preferences in the given category.
